# Generated by Django 2.0.1 on 2018-01-15 06:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_of_death', models.DateField(blank=True, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Enter a bood genre', max_length=200)),
            ],
        ),
        migrations.AddField(
            model_name='book',
